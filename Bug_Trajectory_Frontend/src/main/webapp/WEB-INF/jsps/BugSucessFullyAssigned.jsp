...
<title>BugSucessFullyAssignedPage</title>
<meta charset="utf-8">
...
<div align="center" >
       <h1>Bug SucessFully Assigned!!</h1>  
        <table border="1"  class="table table-dark table-hover table-responsive" style="width:1000px;height:500%;" >
		<tr>
